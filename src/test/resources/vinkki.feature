# language: fi
Ominaisuus: Käyttäjä voi lisätä, poistaa ja listata vinkkejä

    Tapaus: Käyttäjä voi lisätä ja poistaa vinkin
    ...
    Tapaus: Käyttäjä voi lisätä kirjan
        ...
        Niin listalla on kirja otsikolla "Kirjamme" ja kuvauksella "Hyvin lyhyt"