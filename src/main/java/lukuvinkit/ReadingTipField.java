...
public class ReadingTipField<T> {
    ...
    public static final ReadingTipField<String> TYPE =
        new ReadingTipField<>("Tyyppi", STRING_TYPE, Collections.emptyList(), "OTHER");
    ...
    public static final ReadingTipField<Boolean> IS_READ
        = new ReadingTipField<>("Luettu", BOOLEAN_TYPE, Collections.emptyList(), false);
